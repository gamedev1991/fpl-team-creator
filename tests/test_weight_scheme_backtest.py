"""Weight-scheme backtesting (engine.weight_scheme_backtest).
...
from engine.weight_scheme_backtest import (
    SCHEMES,
    TEST_SQUADS,
...
def no_network(monkeypatch):
    ...
    monkeypatch.setattr("engine.weight_scheme_backtest.check_gameweek_finished", lambda gw: None)
    monkeypatch.setattr("engine.weight_scheme_backtest.load_or_build_snapshot", lambda gw, ids: GW1_SNAPSHOT)
...
def test_unfinished_gameweek_is_refused(monkeypatch):
    import engine.weight_scheme_backtest as bt
