...
- Any new scoring weight (`engine/score.py` or `engine/weight_scheme_backtest.py`) should be traceable to
...
**A backtest (`/gw-backtest` or `engine/weight_scheme_backtest.py`):**
